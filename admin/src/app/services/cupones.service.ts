...
export class CuponesService {
    ...
    getAll(filter?: any): Observable<HttpResponse<any>>{
    ...
    update(id: number, data:any): Observable<HttpResponse<any>>{
        return this.http.put<void>(`${environment.API_URL}/api/auth/cupons/${id}`, data, this.httpOptions) as Observable<HttpResponse<any>>;
    }
}